...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='softmax_lossw_param', full_name='caffe.LayerParameter.softmax_lossw_param', index=58,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='multi_stage_meanfield_param', full_name='caffe.LayerParameter.multi_stage_meanfield_param', index=59,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='st_param', full_name='caffe.LayerParameter.st_param', index=60,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='st_loss_param', full_name='caffe.LayerParameter.st_loss_param', index=61,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='power_file_param', full_name='caffe.LayerParameter.power_file_param', index=62,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='loc_loss_param', full_name='caffe.LayerParameter.loc_loss_param', index=63,
...
_POOLINGPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='kernel_size', full_name='caffe.PoolingParameter.kernel_size', index=2,
      number=2, type=13, cpp_type=3, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='stride', full_name='caffe.PoolingParameter.stride', index=3,
      number=3, type=13, cpp_type=3, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='pad_h', full_name='caffe.PoolingParameter.pad_h', index=4,
      number=9, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='pad_w', full_name='caffe.PoolingParameter.pad_w', index=5,
      number=10, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='kernel_h', full_name='caffe.PoolingParameter.kernel_h', index=6,
      number=5, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='kernel_w', full_name='caffe.PoolingParameter.kernel_w', index=7,
...
_SOFTMAXWITHLOSSWPARAMETER = _descriptor.Descriptor(
  name='SoftmaxWithLossWParameter',
  full_name='caffe.SoftmaxWithLossWParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='weight_labels', full_name='caffe.SoftmaxWithLossWParameter.weight_labels', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='labels_weight', full_name='caffe.SoftmaxWithLossWParameter.labels_weight', index=1,
      number=2, type=2, cpp_type=6, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['softmax_lossw_param'].message_type = _SOFTMAXWITHLOSSWPARAMETER
...
DESCRIPTOR.message_types_by_name['SoftmaxWithLossWParameter'] = _SOFTMAXWITHLOSSWPARAMETER
...
SoftmaxWithLossWParameter = _reflection.GeneratedProtocolMessageType('SoftmaxWithLossWParameter', (_message.Message,), dict(
  DESCRIPTOR = _SOFTMAXWITHLOSSWPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.SoftmaxWithLossWParameter)
  ))
_sym_db.RegisterMessage(SoftmaxWithLossWParameter)
