#ifndef CAFFE_EUCLIDEAN_WEIGHT_LOSS_LAYER_HPP_
#define CAFFE_EUCLIDEAN_WEIGHT_LOSS_LAYER_HPP_

//by dong nie, 05/24/2017
...
class EuclideanLossWLayer : public LossLayer<Dtype> {
 public:
  explicit EuclideanLossWLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param), diff_(),tmp_() {}//initialize
 ...
 protected:
  ...
  Blob<Dtype> diff_;
  Blob<Dtype> tmp_;//designed by dong, to save the temporary computational result
};
